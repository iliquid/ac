...
class BreadCrumbs {
    ...
    function __construct(modX &$modx,array $config = array()) {
        ...
        $this->config = array_merge(array(
             ...
             */
            'maxDelimiter' => '...',
            'bcTplCrumbCurrent' => '<li class="breadcrumbs-list__item">[[+text]]</li>',
'bcTplCrumbCurrentLink' => '<a itemprop="url" class="breadcrumbs-list__link breadcrumbs-list__link--last" href="[[~[[+resource]]]]"><span itemprop="title">[[+text]]</span></a>',
'bcTplCrumbFirst' => '<li itemscope itemtype="http://data-vocabulary.org/Breadcrumb" class="breadcrumbs-list__item breadcrumbs-list__item--first">[[+text]]</li>',
'bcTplCrumbHome' => '<a rel="index home" itemprop="url" class="breadcrumbs-list__link" href="[[~[[++site_start]]]]"><span itemprop="title">[[+text]]</span></a>',
'bcTplCrumbLast' => '<li itemscope itemtype="http://data-vocabulary.org/Breadcrumb" class="breadcrumbs-list__item breadcrumbs-list__item--last">[[+text]]</li><li class="breadcrumbs-list__item breadcrumbs-list__item--end"></li>',
'bcTplCrumbMax' => '<li itemscope itemtype="http://data-vocabulary.org/Breadcrumb" class="B_hideCrumb" itemscope="itemscope" itemtype="http://data-vocabulary.org/Breadcrumb">[[+text]]</li>',
'bcTplCrumbLink' => '<a itemprop="url" class="breadcrumbs-list__link rel="[[+description]]" href="[[~[[+resource]]]]"><span itemprop="title">[[+text]]</span></a>',
'bcTplCrumbOuter' => '<ul itemprop="itemListElement" class="breadcrumbs-list">[[+text]]</ul>',
'bcTplCrumb' => '<li itemscope itemtype="http://data-vocabulary.org/Breadcrumb" class="breadcrumbs-list__item">[[+text]]</li>',
